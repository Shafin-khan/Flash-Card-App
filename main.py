...
def next_card():
      ...
      canvas.itemconfig(card_bg_img, image=card_font_image)
...
card_bg_img = canvas.create_image(400, 263, image=card_font_image)

card_back_img = PhotoImage(file='images/card_back.png')
card_title = canvas.create_text(400, 163, text='Title', font=('arial', 40, 'italic'))
...
right_button = Button(image=check_mark, command=next_card)
